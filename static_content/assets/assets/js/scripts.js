...
var breadcrumb_filter = document.getElementById('breadcrumb_filter')
checked_input = document.querySelectorAll(arrCheckbox)

$(arrCheckbox).add(function () {
    breadcrumb_filter.innerHTML = ''
    checked_input.forEach(checked_in =>{
        breadcrumb_filter.innerHTML += checked_in.value + ' / '
    })
})
